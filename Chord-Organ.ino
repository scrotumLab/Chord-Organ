...
December 2018 by Scrotum Lab
- All changes affect pot - Now pot is mixed / att with CV IN. It does not go directly anymore to DAC.
- Main changes: 
-- pot commented
-- cv + pot combi changed
*/
...
//#define CHORD_POT_PIN 9 // pin for Chord pot
#define CHORD_CV_PIN 8 // pin for Chord CV was 6
//#define ROOT_POT_PIN 7 // pin for Root Note pot
#define ROOT_CV_PIN 6 // pin for Root Note CV was 8
...
void printRootInfo(int rootCV) {
    Serial.print("Root CV ");
    Serial.print(rootCV);
    Serial.print(" ");
    Serial.println(rootQuant);
}
